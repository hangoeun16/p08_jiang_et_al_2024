...
To examine whether bank fragility persisted beyond the original study period,
we extend the analysis to Q4~2023--Q4~2025 using FFIEC Single Period Call Reports
data. The methodology is identical: we apply the same ETF-based MTM loss
framework and RMBS multiplier to the updated balance sheet snapshot.
...
\begin{figure}[htbp]
  ...
  \caption{Balance sheet composition of U.S.\ commercial banks as of
           Q4~2024 (FFIEC extension).}
